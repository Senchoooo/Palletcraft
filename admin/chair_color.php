...
<div class="wrapper">
  ...
  <div class="content-wrapper">
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered">
               ...
               <?php
                    ...
                    try{
                      $stmt = $conn->prepare("SELECT * FROM chair_color");
                      $stmt->execute();
                      foreach($stmt as $row){
    ...
    <?php include 'includes/chair_color_modal.php'; ?>
...
function getRow(id){
  $.ajax({
    type: 'POST',
    url: 'chair_color_row.php',
    data: {id:id},
    dataType: 'json',
    success: function(response){
      $('.chaircolorid').val(response.id);
      $('#edit_color').val(response.color);
      $('#edit_price').val(response.price);
      $('.chaircolorname').html(response.color);
    }
  });
}
</script>
