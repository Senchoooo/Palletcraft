            ...
            <div class="box-body">
             <table class="table table-bordered" id="example1">
                    ...
                    <?php
                      ...
                      try{
                        $stmt = $conn->prepare("SELECT *, customization_order.id AS customid, stock_list.id AS stockid FROM customization_order LEFT JOIN users ON users.id=customization_order.user_id LEFT JOIN stock_list ON stock_list.id   WHERE customization_order.ordertype = 'pickup' ORDER BY order_date DESC");
                      $stmt->execute();
                        $total = 0;
