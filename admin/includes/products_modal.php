...
<div class="modal fade" id="addnew">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="products_add.php" enctype="multipart/form-data">
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                   <label for="pallet" class="col-sm-1 control-label">Pallet</label>

                  <div class="col-sm-5">
                    <input type="number" class="form-control" id="pallet" name="pallet" required>
                  </div>
                    <input type="hidden" id="palleta" name="palleta" value="Pallet" readonly>
            ...
            <div class="modal-footer">
              <button type="button" class="btn btn-default btn-flat pull-left" data-dismiss="modal"><i class="fa fa-close"></i> Close</button>
              <button onclick="checkInventory()" type="submit" class="btn btn-primary btn-flat" name="add"><i class="fa fa-save"></i> Save</button>
                                                        <script>
  const stock_list = [
