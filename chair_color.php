  ...
  <?php include 'includes/navbar.php'; ?>
          ...
          <div class="row">
            ...
            <h4 class="text-center"><b>Color</b></h4>
              ...
              <div class="col-sm-6">
               ...
               <form method="POST" action="custom_chair_finalcheckout.php">
    ...
    $conn = $pdo->open();
        ...
        $Height = $_POST['Height'];
            ...
            ?>
             <label>Details</label>
          <input type="text" id="detail" name="detail" style="width:50%;" class="form-control form-control-sm rounded-0" value=<?php echo $shape.",".$height; ?> readonly>
          <br>
          <p><b>Shape Price:</b>  <?php echo $chair; ?></p>

           <p><b>Platform Price:</b>  <?php echo $Height; ?></p>
...
<p><b>Total Price:</b>  <?php echo $total; ?></p>
          ...
          <h3>Select Color</h3>
                   ...
                   <div class="divprice" class="price-style"></div>
                       ...
                       <label>Color</label>
                       <input type="hidden" id="layer_price" name="layer_price" style="width:50%;" class="form-control form-control-sm rounded-0" value=<?php echo $chair; ?> readonly>
          <input type="hidden" id="flatform_quantity_price" name="flatform_quantity_price" style="width:50%;" class="form-control form-control-sm rounded-0" value=<?php echo $Height; ?> readonly>
                 ...
                 <select name="color_price" id="color_price" style="width:50%;" class="form-control form-control-sm rounded-0" onchange="changeddl1(this)" required >
                  ...
                  <?php
                    ...
                    try{
                      $now = date('Y-m-d');
                      $stmt = $conn->prepare("SELECT * FROM chair_color where shape = :shape");
