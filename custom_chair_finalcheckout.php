	    ...
	    <div class="container" >
	      ...
	      <section class="content" >
            ...
            <hr class="border-dark">
	        		...
	        		<input type="text" id="customname" name="customname" style="width:50%;" class="form-control form-control-sm rounded-0" value="Chair" readonly>
...
<select name="barangay" id="barangay" style="width:40%;" class="form-control form-control-sm rounded-0">
 ...
 -->
  	...
  	<?php include 'includes/checkout_modal1.php'; ?>
</div>
