...
<div class="wrapper">
	    ...
	    <div class="container" >
	      ...
	      <section class="content" >
            ...
            <hr class="border-dark">
	        		...
	        		<input type="text" id="customname" name="customname" style="width:50%;" class="form-control form-control-sm rounded-0" value="Plant Stand" readonly>
  ...
  <?php
    ...
    $conn = $pdo->open();
        ...
        ?>
           <?php
				 $total = $layer_price+$flatform_quantity_price+$color_price;
...
<input type="hidden" name="total" id="total" value=<?php echo $total; ?> readonly> 
  					...
  					<h5><b>30% of the Total amount: &#8369; <?= number_format($total*0.3,2) ?></b></h5>
     <div class="alert alert-warning">
                          ...
                          <div style="padding-bottom: 20px;">
                          	 <img  class="pull-left"  src="images/gcash.png" width="100" height="60">
