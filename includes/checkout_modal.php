        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
              <form method="POST" action="ps_sale.php">
                ...
                <input style="text-align: center;" type="text" id="customname" name="customname" style="width:100%;" class="form-control form-control-sm rounded-0" value="Plant Stand" readonly>
