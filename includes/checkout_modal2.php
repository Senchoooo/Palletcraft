    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
              <form method="POST" action="ps_sale.php">
                ...
                <input style="text-align: center;" type="text" id="customname" name="customname" style="width:100%;" class="form-control form-control-sm rounded-0" value="Table" readonly>
                 ...
                 <label>Detail</label>
          <input style="text-align: center;" type="text" id="detail" name="detail" style="width:100%;" class="form-control form-control-sm rounded-0" value=<?php echo $table; ?> readonly>
       ...
       <input style="text-align: center;" type="text" id="color" name="color" style="width:100%;" class="form-control form-control-sm rounded-0" value=<?php echo $color; ?> readonly>
            ...
            <label>Province</label>
                    <select id="province" name="province" style="width:100%;" class="form-control form-control-sm rounded-0"><option value="" disabled selected="selected">Select Province</option></select>
                    <label>City</label>
