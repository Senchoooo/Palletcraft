...
<div class="wrapper">
  ...
  <?php include 'includes/navbar.php'; ?>
          ...
          <div class="row">
            ...
            <h4 class="text-center"><b>Color</b></h4>
              ...
              <div class="col-sm-6">
               ...
               <form method="POST" action="custom_finalcheckout.php">
    ...
    $conn = $pdo->open();
        ...
        $flatform_quantity_price = $_POST['flatform_quantity_price'];
     }
            $pdo->close();
            ?>
             <label>Details</label>
          <input type="text" id="detail" name="detail" style="width:50%;" class="form-control form-control-sm rounded-0" value=<?php echo $layer.",".$platform; ?> readonly>
          <br>
          <p><b>Layer Price:</b>  <?php echo $layer_price; ?></p>

           <p><b>Platform Price:</b>  <?php echo $flatform_quantity_price; ?></p>

           <?php
            $total = $layer_price+$flatform_quantity_price;
...
<p><b>Total Price:</b>  <?php echo $total; ?></p>
          ...
          <h3>Select Color</h3>
                   ...
                   <div class="divprice" class="price-style"></div>
                       ...
                       <label>Color</label>
                       <input type="hidden" id="layer_price" name="layer_price" style="width:50%;" class="form-control form-control-sm rounded-0" value=<?php echo $layer_price; ?> readonly>
          <input type="hidden" id="flatform_quantity_price" name="flatform_quantity_price" style="width:50%;" class="form-control form-control-sm rounded-0" value=<?php echo $flatform_quantity_price; ?> readonly>
                 ...
                 <select name="color_price" id="color_price" style="width:50%;" class="form-control form-control-sm rounded-0" onchange="changeddl1(this)" required >
                  ...
                  <?php
                    ...
                    try{
                      $now = date('Y-m-d');
                      $stmt = $conn->prepare("SELECT * FROM customize_ps_color where flatform_quantity=:flatform_quantity");
                     $stmt->execute(['flatform_quantity' => $platform]);
                      foreach($stmt as $row){
