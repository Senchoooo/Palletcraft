  ...
  <section class="sidebar">
    ...
    <div class="user-panel">
      <div class="pull-left image">
        <img src="<?php echo (!empty($staff['photo'])) ? '../images/'.$staff['photo'] : '../images/profile.jpg'; ?>" class="img-circle" alt="User Image">
      </div>
      <div class="pull-left info">
        <p><?php echo $staff['firstname'].' '.$staff['lastname']; ?></p>
   ...
   <!--       <li class="treeview">
    ...
    <!--      <li class="treeview">
     ...
     <li><a href="inventory.php"><i class=></i> <span>Inventory</span></a></li>
     <!--       <li class="treeview">
        <a href="#">
          <i ></i>
          <span>Inventory</span>
        ...
        <ul class="treeview-menu">
          <li><a href="inventory.php"><i class="fa fa-circle-o"></i> <span>Stock In</span></a></li>
    ...
    <!--       <li class="treeview">
      ...
      <!-- <li><a href="table.php"><i></i> <span>Table</span></a></li> -->
      <li><a href="color.php"><i></i> <span>Colors</span></a></li>
